...
import type { ProcessedAnalysisData } from '@/app/(dashboard)/analysis/revenue/revenue-analysis-calculation';
...
export const transformAnalysisDataForExcel = (
	...
	return analyses.map((analysis) => ({
		...
		'Sales Growth Adj. Rate': analysis.salesGrowthAdjustedRate,
		'Sales Growth +0': analysis.sales_growth_0,
		'Sales Growth +1': analysis.sales_growth_1,
		'Sales Growth +2': analysis.sales_growth_2,
		'Sales Growth Avg': analysis.sales_growth_avg,
		'PSG Ratio': analysis.psg_ratio,
		'성장성 Valuation (PSR)': analysis.growth_valuation,
		'성장성 Valuation Price': analysis.growth_valuation_price,
		'성장수익성 Valuation (PSR)': analysis.growth_profitability_valuation,
 ...
 */
export const createRevenueDataAndDownloadExcel = (
...
export const exportRevenueAnalysis = (
	...
	return createRevenueDataAndDownloadExcel(data, {
